...
//FUNCIONES DE LA CLASE
	...
	*/
	...
	private function getLoginForm()
	{
			...
			if($_COOKIE["loginError"] < 3)
			{
				$fstrForm = $fstrForm."\t<form action=\"".$this->login()."\" method=\"POST\" class=\"form-signin\" role=\"form\">\n";
			...
			{
				$fstrForm = $fstrForm."\t<a href='Index.php'><h3>Ha superado el número de intentos, seguidos, permitidos, por favor espere 60 segundos para volverlo a intentar</h3></a>";
			}
