...
class Header extends Element
{
	...
	private $menuElements=array("home"=>array("txt"=>"Inicio",
											  "url"=>"http://192.168.1.13/html/DAW/PROYECTO05/Index.php?id=1",
											  "visible"=>true),
								"pictures"=>array("txt"=>"Fotos",
												  "url"=>"http://192.168.1.13/html/DAW/PROYECTO05/Index.php?id=2",
												  "visible"=>false),
								"places"=>array("txt"=>"Lugares",
												"url"=>"http://192.168.1.13/html/DAW/PROYECTO05/Index.php?id=3",
												"visible"=>false),
								"contact"=>array("txt"=>"Contactos",
  												 "url"=>"http://192.168.1.13/html/DAW/PROYECTO05/Index.php?id=4",												 												 "visible"=>false),
